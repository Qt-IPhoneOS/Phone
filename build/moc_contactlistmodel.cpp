...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_ContactListModel_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_ContactListModel_t qt_meta_stringdata_ContactListModel = {
    {
        QT_MOC_LITERAL(0, 16),  // "ContactListModel"
        QT_MOC_LITERAL(17, 18),  // "contactListChanged"
        QT_MOC_LITERAL(36, 0),  // ""
        QT_MOC_LITERAL(37, 8),  // "rowCount"
...
Q_CONSTINIT static const uint qt_meta_data_ContactListModel[] = {
 ...
 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       3,    0,   36,    2, 0x122,    4 /* Public | MethodCloned | MethodIsConst  */,
...
Q_CONSTINIT const QMetaObject ContactListModel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ContactListModel.offsetsAndSizes,
...
void ContactListModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &ContactListModel::contactListChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ContactListModel::contactListChanged()
{
