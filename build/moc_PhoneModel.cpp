...
Q_CONSTINIT static const qt_meta_stringdata_PhoneModel_t qt_meta_stringdata_PhoneModel = {
    {
        ...
        QT_MOC_LITERAL(11, 18),  // "contactListChanged"
        QT_MOC_LITERAL(30, 0),  // ""
        QT_MOC_LITERAL(31, 8),  // "rowCount"
        QT_MOC_LITERAL(40, 11),  // "QModelIndex"
        QT_MOC_LITERAL(52, 6)   // "parent"
    },
    "PhoneModel",
    "contactListChanged",
    "",
...
void PhoneModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PhoneModel::*)();
            if (_t _q_method = &PhoneModel::contactListChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void PhoneModel::contactListChanged()
{
